...
* **Visible map area search by default:** Panning or zooming the map automatically triggers a bounds change listener, filtering the sidebar list and map markers to only show venues currently within the visible bounding box of the map. This creates a reactive, Google Maps-like discovery experience.
